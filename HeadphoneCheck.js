...
(function(HeadphoneCheck, $, undefined) {
  ...
  HeadphoneCheck.loadStimuli = function (jsonPath) {
    ...
    if (jsonPath === undefined) {
      var data = {'stimuli':[
                    {'id': 1, 'src': './assets_sijia/antiphase_HC_ISO.flac', 'correct': '2'},
                    {'id': 2, 'src': './assets_sijia/antiphase_HC_IOS.flac', 'correct': '3'},
                    {'id': 3, 'src': './assets_sijia/antiphase_HC_SOI.flac', 'correct': '1'},
                    {'id': 4, 'src': './assets_sijia/antiphase_HC_SIO.flac', 'correct': '1'},
                    {'id': 5, 'src': './assets_sijia/antiphase_HC_OSI.flac', 'correct': '2'},
                    {'id': 6, 'src': './assets_sijia/antiphase_HC_OIS.flac', 'correct': '3'}
                  ],
        'calibration': {'src': './assets_sijia/noise_calib_stim.flac'}
      };
